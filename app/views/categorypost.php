 <?php
        $name = 'Danh mục chưa có tin tức';
         foreach($postbyid as $key =>$post_name){
         $name = $post_name['title_Cpost'];
      }
?>
<style type="text/css">
                               .img-list img {
               ...
               <div class="wrapper_all_main_right">
                  ...
                  <div class="breadcrumbs">
                     <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope
                           itemtype="http://schema.org/ListItem">
                           <a itemprop="item" href="<?php echo BASE_URL ?>/tintuc/tatca">
                        ...
                        <li itemprop="itemListElement" itemscope
                           itemtype="http://schema.org/ListItem">
                           <span itemprop="item">
                           <strong itemprop="name" style="font-weight:500;">
                           <?php echo $name ?>
                           </strong>  
                           </span>
                              ...
                              <div class="content-list">
                                 <div class="content-list_inm">
                                    <div class="title-list">
                                       <h3>
                                          <a style="font-size: 18px;color:rgb(255,91,91);" href="<?php echo BASE_URL ?>/tintuc/chitiettin/<?php echo $post['id_post'] ?>"><?php echo $post['title_post'] ?></a>
                                       </h3>
