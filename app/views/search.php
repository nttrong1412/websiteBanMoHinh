...
<section>
   ...
   <div class="breadcrumbs">
      <ol itemscope itemtype="http://schema.org/BreadcrumbList">
         ...
         <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a itemprop="item" >
            <span itemprop="name">Sản phẩm tìm được</span></a>
   ...
   <div class="module_pro_all">
      <div class="box-title">
         <div class="title-bar">
            <h1>Sản phẩm tìm được</h1>
         </div>
      </div>
      <div class="pro_all_gird">
         <div class="girds_all list_all_other_page ">
            <?php foreach ($category_seach as $key => $product) {
               ...
               <div class="grids_in">
                  <div class="content">
                     <div class="img-right-pro">
                        <a >
                        <img class="lazy img-pro content-image" src="<?php echo BASE_URL?>/public/uploads/product/<?php echo $product['image'] ?>" data-original="image/iphone.png" alt="Máy in Canon MF229DW" />
                        </a>
