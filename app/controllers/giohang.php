...
class giohang extends DController{
	...
	public function dathang(){
			...
			if(Session::get("shopping_cart")==true){
				...
				$tieude = "Đặt hàng webside trongdochoi.com thành công";
				$noidung = "<h4>Cảm ơn quý khách đã đặt hàng của chúng tôi với mã đơn hàng là :".$order_code."</h4>";
				...
				foreach(Session::get("shopping_cart") as $key => $val){
					...
					<li>"."Tên sản phẩm :".$val['product_title']."</li>
					<li>"."Id sản phẩm :".$val['product_id']."</li>
					<li>"."Giá sản phẩm :".number_format($val['product_price'],0,',','.').'đ'."</li>
					<li>"."Số lượng sản phẩm :".$val['product_quantity']."</li>
